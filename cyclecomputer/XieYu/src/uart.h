/*
 * This is the header file for serial communication library.
 */
#ifndef _UART_H_
#define _UART_H_
...
/**
UART ports are numbered from 0 to NUMBER_OF_UART_PORT-1.
The macro NUMBER_OF_UART_PORT should be defined in Makefile,
otherwise will 4 will be used (and four sets of buffers will
be allocated statically).
*/

/**	init port with default parameters: 9600, 8n1
